...
theme.set_highlights = function()
  ...
  hl(0, "NoiceCmdlineIconInput", { link = 'Special' })
  hl(0, "NoiceCmdlinePopupBorderLua", { fg = c.function_, bg = c.bg })
  hl(0, "NoiceCmdlinePopupBorderFilter", { fg = c.special, bg = c.bg })
  hl(0, "NoiceCmdlinePopupBorderSearch", { fg = c.warning, bg = c.bg })
  hl(0, "NoiceCmdlinePopupBorderInput", { fg = c.error, bg = c.bg })
  hl(0, "NoiceCmdlinePopupTitleInput", { fg = c.float_bg, bg = c.error, bold=true, })
